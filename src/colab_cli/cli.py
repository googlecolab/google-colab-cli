...
def callback(
    ...
    auth: Annotated[
        ...
        typer.Option(
            "--auth",
            help=(
                "Authentication strategy to use: 'loas2' (internal stubby/SSO),"
                " 'oauth2' (public InstalledAppFlow), or 'adc' (Application"
                " Default Credentials)."
            ),
    ...
    #     pipelines.
    _AUTO_UPDATE_SUPPRESSED = {"update", "version", "log", "pay", "help", "url"}
