...
class Client:
    ...
    def keep_alive_assignment(self, endpoint: str):
        ...
        headers = {
            ...
            # The Boq frontend at colab.pa.googleapis.com requires
            # X-Goog-Api-Client to contain "grpc-web", otherwise it rejects
            # the request with HTTP 400 ("Invalid GRPC-Web request").
            ...
            # this explicitly forces Boq to use Colab's project as the consumer
            # for both the API-key check and quota accounting, which all
            # google.com Gaia identities have implicit access to via the
            # public web client. Verified empirically 2026-04-30.
